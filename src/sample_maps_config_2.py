...
if __name__ == "__main__":
    ...
    print "\nTotal train tracks: " + str(len(track_wav_paths))
    ...
    for subdir_name in os.listdir(DATASET_DIR):
        ...
        if not os.path.isdir(subdir_path) or subdir_name not in TEST_DIRS:
            continue
    ...
    print "\nTotal test tracks: " + str(len(track_wav_paths))
    total_size = total_size / 1000000.0
    ...
    print "Copied to " + MAPS_SUBSET_CONFIG_2_DIR_TEST + '\n'
